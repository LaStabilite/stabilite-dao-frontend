...
function Zapin({ open, handleClose, bond }: IZapinProps) {
  ...
  const setMax = () => {
    ...
    let amount: any = Math.min(
      maxBondPriceToken,
      token.isAvax ? token.balance * 0.99 : token.balance,
    );
          ...
          <div className="zapin-header">
              ...
              <OutlinedInput
                ...
                startAdornment={
                  <InputAdornment position="start">
                    <div
                      ...
                      className="zapin-header-token-select-input-token-select"
                    >
                      <img
                        className="zapin-header-token-select-input-token-select-logo"
                        src={token.img}
                        alt=""
                      />
                      <p>{token.name}</p>
                ...
                endAdornment={
                  <InputAdornment position="end">
                    <div
                      className="zapin-header-token-select-input-btn"
                      onClick={setMax}
                    >
                      <p>Max</p>
                    </div>
            ...
            {!hasAllowance() && !token.isAvax && (
              <div className="zapin-header-help-text">
                <p>
                  Note: The "Approve" transaction is only needed when bonding
                  for the first time
                </p>
                <p>
                  for each token; subsequent bonding only requires you to
                  perform the
                </p>
          ...
          <div className="zapin-body">
            ...
            <div className="zapin-body-params">
              ...
              <div className="data-row">
                ...
                <p className="data-row-value">{`${trim(token.balance, 6)} ${
                  token.name
                }`}</p>
              </div>
              <div className="data-row">
                ...
                <p className="data-row-value">
                  {isLoading ? (
                    ...
                    `${minimumReceivedAmount} ${bond.displayUnits}`
                  )}
                </p>
              </div>
              <div className="data-row">
